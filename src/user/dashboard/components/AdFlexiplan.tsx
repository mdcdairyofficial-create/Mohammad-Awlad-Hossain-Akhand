          ...
          <div className="space-y-6 bg-slate-50 dark:bg-slate-800/30 p-8 rounded-[2rem] border-2 border-slate-100 dark:border-slate-800/50">
            ...
            <div className="space-y-5">
              <div className="relative group/input">
                ...
                {fbLink && (
                  <div className="mt-4">
                    <label className="text-[10px] font-black text-rose-500 uppercase tracking-widest ml-4 mb-2 block">{t('MDC DAIRY ফেসবুক কাভার ফটো', 'MDC DAIRY FB COVER PHOTO')}</label>
                    <input 
                      type="file" 
                      accept="image/*"
